...
class ResumeTempController extends GetxController {
  ...
  // Is presseds
  TextEditingController twitter_unme = TextEditingController(text: "Aarush__Acharya");
  TextEditingController linkedIn_unme = TextEditingController(text: "Aarush Acharya");
